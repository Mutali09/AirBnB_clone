...
class FileStorage:
    ...
    Attributes:
        __file_path (str): The path to JSON file for storing objects.
    ...
    def new(self, obj):
        """Add a new object to storage with a unique key.

        Args:
            obj: An instance of a class derived from BaseModel.

        Description:
            This method stores the object using a key <obj_class_name>.id.
        """
